...
const COMPONENT_REGISTRY: Record<string, () => Promise<{ default: LazyComponent }>> = {
  ...
  "industrial-dashboard": () => import("@/components/genui/IndustrialDashboardBlock") as any,
  ...
  "point-selector": () => import("@/components/genui/PointSelectorBlock") as any,
  "point-selector-multi": () => import("@/components/genui/PointSelectorMultiBlock") as any,
