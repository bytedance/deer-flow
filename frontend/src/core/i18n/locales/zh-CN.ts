...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    modelInherited: "继承（默认）",
    toolGroups: "工具组",
    toolGroupsPlaceholder: "例如 file:read, bash（留空则使用全部工具）",
    toolGroupsAll: "全部工具",
    name: "名称",
    namePlaceholder: "my-agent",
    nameHint: "只允许小写字母、数字和连字符（例如 code-reviewer）",
    descriptionLabel: "描述",
    descriptionPlaceholder: "这个智能体擅长什么？",
    soul: "灵魂（SOUL.md）",
    soulPlaceholder: "描述该智能体的个性、价值观和行为准则……",
    soulHint: "将注入到 lead agent 的系统提示词之后，定义该智能体的身份与风格。",
    createTitle: "新建智能体",
    editTitle: "编辑智能体",
    ...
    nameStepHint: "只允许小写字母、数字和连字符（例如 code-reviewer）",
    nameStepPlaceholder: "例如 code-reviewer",
    nameStepContinue: "继续",
    nameStepInvalidError: "名称无效，只允许小写字母、数字和连字符",
    chatOpening: "好的！现在告诉我「{name}」应该做什么——描述它的用途、性格和专长领域。",
    creating: "正在创建智能体…",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
