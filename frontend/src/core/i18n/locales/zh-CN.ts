...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    settingsLoadError: "无法加载该智能体的详情，请重试。",
    settingsSectionModel: "模型",
    settingsSystemPrompt: "系统提示词",
    settingsSystemPromptHint: "该智能体的 SOUL.md——它的人设与行为准则。",
    settingsSystemPromptPlaceholder: "描述这个智能体应如何行动……",
    settingsSkills: "技能",
    settingsSkillsUseAll: "使用全部已启用技能",
    settingsSkillsUseAllHint:
      "该智能体可使用服务器上所有已启用的技能。关闭后可只选其中一部分。",
    settingsSkillsEmpty: "没有可选的已启用技能。",
  },
