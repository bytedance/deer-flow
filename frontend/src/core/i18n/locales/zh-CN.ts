...
export const zhCN: Translations = {
  ...
  settings: {
    ...
    models: {
      ...
      editModel: "编辑模型",
      deleteModel: "删除模型",
      deleteConfirm: "确定要删除此模型吗？此操作无法撤销。",
      saved: "模型配置已保存。",
      deleted: "模型已删除。",
      ...
      displayName: "显示名称",
      description: "描述",
      descriptionPlaceholder: "可选的模型描述",
      providerClass: "提供者",
      providers: {
        placeholder: "选择提供者…",
        openai: "OpenAI",
        deepseek: "DeepSeek / 火山引擎",
        anthropic: "Anthropic Claude",
        gemini: "Google Gemini",
        ollama: "Ollama（本地）",
        patchedOpenAI: "OpenAI 兼容（补丁版）",
        mimo: "小米 MiMo",
        stepfun: "阶跃星辰",
        minimax: "MiniMax",
        vllm: "vLLM",
      ...
      modelId: "模型 ID",
      apiKey: "API 密钥",
      apiKeyPlaceholder: "输入密钥 — 将存储在 .env 中",
      apiKeyPlaceholderEdit: "留空以保留现有密钥",
      apiBase: "API 基础 URL",
      capabilities: "能力",
      supportsVision: "视觉",
      supportsThinking: "思考",
