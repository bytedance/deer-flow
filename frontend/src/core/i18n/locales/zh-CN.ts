...
export const zhCN: Translations = {
  ...
  globalVariables: {
    ...
    valueLabel: "变量值",
    descriptionLabel: "描述",
    llmEditableLabel: "大模型可编辑",
    llmEditableHint: "允许大模型通过工具修改此变量",
    keyPlaceholder: "变量名",
    valuePlaceholder: "变量值",
    descriptionPlaceholder: "描述（选填）",
    save: "保存",
    validationKey: "变量名不能为空",
    validationValue: "变量值不能为空",
    noVariables: "暂无变量",
    scopeLabel: "作用域",
    scopeProject: "项目级",
    scopeThread: "对话级",
    selectThreadLabel: "选择对话",
    searchThreadPlaceholder: "搜索对话...",
    table: {
      key: "变量名",
      value: "变量值",
      description: "描述",
