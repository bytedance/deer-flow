...
export const zhCN: Translations = {
  ...
  sidebar: {
    ...
    knowledgeDisabledTooltip: "知识库功能未启用",
  },

  // 知识库
  knowledge: {
    title: "知识库",
    description: "管理由 RAGFlow 提供的共享语料与文档解析。",
    sharedBannerTitle: "本部署上的知识库由所有 DeerFlow 用户共享",
    sharedBannerDescription:
      "你上传或创建的内容对本部署中的其他用户可见。删除操作仅限管理员，因为它会影响所有用户。",
    featureDisabledTitle: "知识库功能未启用",
    featureDisabledDescription:
      "该服务器尚未启用 RAGFlow 知识库集成，请联系管理员。",
    loadFailed: "加载知识库失败",
    retry: "重试",
    emptyTitle: "还没有知识库",
    emptyDescription: "创建第一个共享知识库，然后上传文档开始解析。",
    create: {
      action: "新建知识库",
      title: "新建共享知识库",
      description:
        "知识库会立即在 RAGFlow 中创建，并对所有 DeerFlow 用户可见。",
      name: "名称",
      namePlaceholder: "例如：产品文档",
      datasetDescription: "描述",
      descriptionPlaceholder: "说明该知识库包含的内容（可选）",
      submit: "创建",
      submitting: "正在创建…",
      success: "知识库已创建",
    },
    dataset: {
      ...
      open: "查看文档",
      delete: "删除知识库",
      adminOnly: "只有管理员可以删除共享知识库。",
      deleteTitle: "删除共享知识库？",
      deleteDescription:
        "这会从 RAGFlow 永久删除知识库及其文档，并影响所有用户。",
      deleteConfirm: "确认删除",
      deleting: "正在删除…",
    ...
    detail: {
      back: "返回知识库",
      notFound: "未找到该知识库，可能已在 RAGFlow 中被删除。",
      documents: "文档",
      noDocuments: "还没有文档",
      noDocumentsDescription:
        "将文件拖到上方上传区，文件不会在 DeerFlow 本地落盘。",
      selectAll: "全选文档",
      ...
      delete: "删除所选文档",
      deleteTitle: "删除所选文档？",
      deleteDescription: "文档将从共享知识库中永久删除，并影响所有用户。",
      deleteConfirm: "确认删除",
      deleting: "正在删除…",
      parseSuccess: "已提交解析任务",
      deleteSuccess: "文档已删除",
    },
    upload: {
      title: "上传文档",
      description: "最多 10 个文件；单文件 50 MB；单次请求总计 100 MB。",
      dropHere: "拖放文件到这里",
      browse: "或点击选择文件",
      uploading: "正在上传…",
      success: "文档已上传",
      ...
      fileTooLarge: "单个文件不能超过 50 MB。",
      requestTooLarge: "单次上传总大小不能超过 100 MB。",
    },
    ragflow: {
      title: "高级管理",
      description:
        "编辑 Chunk、配置解析器、检索测试以及 Chat/Agent 管理不在 DeerFlow 中重复实现。",
      items: [
        "Chunk 与 metadata 编辑",
        "知识图谱、RAPTOR 与 ingestion pipeline 配置",
        "RAGFlow Chat Assistant 与 Agent 管理",
        "RAGFlow Chat Completion",
        "由 Agent 发起的知识库写操作",
      ],
      open: "在 RAGFlow 中打开",
      unavailable: "RAGFlow 管理页面地址不可用，请联系管理员。",
    },
    errors: {
      create: "创建知识库失败",
      deleteDataset: "删除知识库失败",
      upload: "上传文档失败",
      parse: "触发解析失败",
