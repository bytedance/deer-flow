...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    nameStepTitle: "给新智能体起个展示名",
    nameStepHint: "支持中文、英文和空格等自然名称，系统会自动生成内部标识符。",
    nameStepPlaceholder: "例如 代码审查助手",
    nameStepContinue: "继续",
    nameStepInvalidError: "请输入有效的智能体名称",
    nameStepAlreadyExistsError: "已存在同名智能体",
    nameStepNetworkError: "网络请求失败，请检查网络或后端连接",
    nameStepCheckError: "无法验证名称可用性，请稍后重试",
    nameStepBootstrapMessage:
      "新智能体的展示名称是 {name}，现在开始为它生成 **SOUL**。",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
