  ...
  settings: {
    ...
    imageModels: {
      ...
      statuses: {
        not_configured: "未配置",
        invalid_config: "配置无效",
        configured_unverified: "已配置，能力尚未验证",
        ready: "生成和参考图编辑均已验证",
        unreachable: "无法连接提供方",
      },
      ...
      generationReady: "生成已验证",
      generationUntested: "生成未验证",
      editReady: "参考图编辑已验证",
      editUntested: "参考图编辑未验证",
      testGeneration: "测试图片生成",
      testEdit: "测试参考图编辑",
      working: "处理中…",
      formDescription:
      ...
      results: {
        ...
        rate_limited: "触发提供方限流，请稍后重试。",
        unsupported_edit: "该模型或接口不支持参考图编辑。",
        provider_rejected: "提供方拒绝请求，请检查模型和地址。",
        invalid_response: "提供方未返回图片数据。",
        unreachable: "无法连接提供方，请检查网络和地址。",
        missing_api_key: "请先配置图片模型 API Key。",
      },
    },
    sections: {
      models: "模型",
