...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    nameStepCheckErrorWithDetail: "名称检查失败：{detail}",
  ...
  settings: {
    ...
    models: {
      title: "模型",
      description:
        "添加 OpenAI 兼容模型，调整运行参数，并让它们出现在聊天模型选择器中。",
      baseUrlPlaceholder: "OpenAI 兼容 Base URL",
      apiKeyPlaceholder: "API Key",
      detect: "检测",
      detecting: "检测中...",
      detectSuccess: (count: number) => `检测到 ${count} 个模型`,
      add: "添加",
      edit: "编辑",
      clear: "清空",
      manualModel: "手动配置",
      ...
      requiredFieldsMissing: (fields: string) => `请填写必填项：${fields}`,
    },
    skills: {
      title: "技能",
