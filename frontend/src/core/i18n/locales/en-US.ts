...
export const enUS: Translations = {
  ...
  settings: {
    ...
    models: {
      title: "Models",
      description:
        "Add OpenAI-compatible models, tune their runtime options, and make them available in chat.",
      baseUrlPlaceholder: "OpenAI-compatible base URL",
      apiKeyPlaceholder: "API key",
      detect: "Detect",
      detecting: "Detecting...",
      detectSuccess: (count: number) =>
        `Detected ${count} model${count === 1 ? "" : "s"}`,
      add: "Add",
      edit: "Edit",
      clear: "Clear",
      manualModel: "Manual configuration",
      ...
      baseUrl: "Base URL",
      apiKey: "API key",
      keepApiKey: "Leave blank to keep current key",
