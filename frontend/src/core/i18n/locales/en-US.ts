...
export const enUS: Translations = {
  ...
  globalVariables: {
    ...
    description: "Manage variables injected into the AI model's system prompt",
    ...
    llmEditableLabel: "LLM Editable",
    llmEditableHint: "Allow the AI model to modify this variable via tools",
    keyPlaceholder: "Variable key",
    valuePlaceholder: "Variable value",
    descriptionPlaceholder: "Description (optional)",
    save: "Save",
    validationKey: "Variable key is required",
    validationValue: "Variable value is required",
    noVariables: "No variables yet",
    scopeLabel: "Scope",
    scopeProject: "Project",
    scopeThread: "Thread",
    selectThreadLabel: "Select thread",
    searchThreadPlaceholder: "Search threads...",
    table: {
      key: "Key",
      value: "Value",
      description: "Description",
      llmEditable: "LLM Editable",
      operations: "Actions",
    },
    llmAllowed: "Allowed",
    llmForbidden: "Forbidden",
    systemLabel: "System Variable",
    systemHint: "System variables are read-only",
  },
};
