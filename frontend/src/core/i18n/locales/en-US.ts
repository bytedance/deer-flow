...
export const enUS: Translations = {
  ...
  settings: {
    ...
    models: {
      ...
      description:
        "Manage AI model providers and their connection settings. Changes take effect on the next message.",
      empty: "No models configured. Add a model to get started.",
      countSingular: "model configured",
      countPlural: "models configured",
      addModel: "Add Model",
      ...
      descriptionPlaceholder: "Optional description of this model",
      providerClass: "Provider",
      providers: {
        placeholder: "Select a provider…",
        openai: "OpenAI",
        deepseek: "DeepSeek / Volcengine",
        anthropic: "Anthropic Claude",
        gemini: "Google Gemini",
        ollama: "Ollama (local)",
        patchedOpenAI: "OpenAI-compatible (patched)",
        mimo: "Xiaomi MiMo",
        stepfun: "StepFun",
        minimax: "MiniMax",
        vllm: "vLLM",
      ...
      modelId: "Model ID",
      apiKey: "API key",
      apiKeyPlaceholder: "Enter key — stored in .env",
      apiKeyPlaceholderEdit: "Leave empty to keep existing",
