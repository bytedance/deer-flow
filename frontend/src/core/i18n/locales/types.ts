...
export interface Translations {
  ...
  settings: {
    ...
    modelServices: {
      ...
      discoverModelsTitle: string;
      discoverModelsDescription: string;
      discoverModelsSearchPlaceholder: string;
      discoverModelsEmpty: string;
      importSelectedModels: string;
      selectedModelsCount: (count: number) => string;
      ...
      systemModelsDescription: string;
      createManagedProvider: string;
      createManagedProviderDescription: string;
      sourceConfig: string;
