...
export const MessageContent = ({
  ...
  <div
    className={cn(
      "is-user:dark flex w-fit max-w-full min-w-0 flex-col gap-2 overflow-visible font-claude-response-body",
      "group-[.is-user]:overflow-hidden",
      "group-[.is-user]:bg-muted group-[.is-user]:text-foreground dark:group-[.is-user]:bg-[rgb(24_24_22)] group-[.is-user]:max-w-[82%] group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:font-claude-user-body",
