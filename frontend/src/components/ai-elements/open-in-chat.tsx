...
const providers = {
  ...
  scira: {
    title: "Open in Scira",
    createUrl: (q: string) =>
      `https://   scira.ai/?${新建 URLSearchParams({
        q,
      })}`,
    icon: (
      <svg
  ...
  chatgpt: {
    ...
    createUrl: (prompt: string) =>
      `https://   chatgpt.com/?${新建 URLSearchParams({
        hints: "search",
        prompt,
      })}`,
    icon: (
  ...
  claude: {
    ...
    createUrl: (q: string) =>
      `https://   claude.ai/新建?${新建 URLSearchParams({
        q,
      })}`,
    icon: (
      <svg
  ...
  t3: {
    ...
    createUrl: (q: string) =>
      `https://   t3.聊天/新建?${新建 URLSearchParams({
        q,
      })}`,
  ...
  v0: {
    title: "Open in v0",
    createUrl: (q: string) =>
      `https://   v0.app?${新建 URLSearchParams({
        q,
      })}`,
    icon: (
      <svg
  ...
  cursor: {
    ...
    createUrl: (text: string) => {
      const url = new URL("https://   cursor.com/link/提示词");
