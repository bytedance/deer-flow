...
**原因**：多个子 Agent 共用 AIO 的隐式 shell 会话，或者会话数超过镜像上限被驱逐。[#5134](https://github.com/bytedance/deer-flow/pull/5134) 给每个子 Agent 独立的执行租约与持久会话，[#5178](https://github.com/bytedance/deer-flow/pull/5178) 按 `max_running + 1` 自动设置 `MAX_SHELL_SESSIONS`。
