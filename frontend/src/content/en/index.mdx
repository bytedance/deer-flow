...
- [Why DeerFlow](./introduction/why-deerflow)
- [Harness vs App](./introduction/harness-vs-app)
...
- If you are **evaluating the project**, start with [Introduction](./introduction).
- If you are **building your own agent system**, start with [DeerFlow Harness](./harness).
- If you are **deploying DeerFlow for users**, start with [DeerFlow App](./application).
- If you want to **learn by doing**, go to [Tutorials](./tutorials/first-conversation).
