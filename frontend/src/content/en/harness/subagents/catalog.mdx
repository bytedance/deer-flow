...
On top of that, `subagents.agents.<name>` can override `timeout_seconds`, `max_turns`, `model`, `skills`, and `token_budget` for a subagent from any source. The Settings catalog shows those overrides.
...
subagents:
  custom_agents:
    analysis:
      ...
      disallowed_tools:      # default; task / ask_clarification / present_files are always denied
        - task
        - ask_clarification
        - present_files
...
| Field                        | Notes                                                                                              |
| ---------------------------- | -------------------------------------------------------------------------------------------------- |
| `name`                       | Letters, digits, and hyphens only; used as the `subagent_type`                                     |
