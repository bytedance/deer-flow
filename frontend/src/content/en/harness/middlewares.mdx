...
1. Runtime middlewares (input/output sanitization, thread data, uploads, sandbox and audit, dangling tool-call patching, LLM/tool error handling, plus tool receipts, authorization/guardrail, read-before-write, and tool-progress guards when enabled)
