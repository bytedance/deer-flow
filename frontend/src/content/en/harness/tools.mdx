...
Invokes an external agent using the [Agent Client Protocol (ACP)](https://agentclientprotocol.com/). Requires `acp_agents:` configuration in `config.yaml`. See the [Subagents](/docs/harness/subagents) page for ACP configuration.
