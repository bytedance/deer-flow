...
```
Results include the content of each page, not only a snippet. Requires a [Sofya](https://sofya.co) API key. `max_results` is capped at 20. Also supports `web_fetch`.
  </Tabs.Tab>
</Tabs>
