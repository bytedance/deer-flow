...
The contract package is versioned separately from DeerFlow. The current version is `deerflow-extension-api` **0.2.3**, exposed as `deerflow_extension_api.API_VERSION`.
