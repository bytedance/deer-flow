...
import { ChatsSettingsPage } from "@/components/workspace/settings/chats-settings-page";
    ...
    >
      ...
      >
        ...
        <div className="grid min-h-0 flex-1 gap-4 md:grid-cols-[220px_minmax(0,1fr)]">
          ...
          <ScrollArea className="obs-settings-panel h-full min-h-0 rounded-lg border bg-background">
