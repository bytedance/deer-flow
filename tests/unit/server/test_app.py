...
class TestClarificationFeature:
    """Test cases for the clarification feature."""

    @pytest.mark.asyncio
    async def test_clarification_workflow_integration(self):
    ...
    def test_clarification_parameters_combinations(self):
    ...
    def test_coordinator_tools_with_clarification_enabled(self, mock_get_llm):
        ...
        # Mock LLM response
        mock_llm = MagicMock()
        mock_response = AIMessage(content="Let me clarify...")
    ...
    @patch("src.graph.nodes.get_llm_by_type")
    def test_coordinator_tools_with_clarification_disabled(self, mock_get_llm):
