...
description: Use this skill when the user requests to generate, create, imagine, draw, visualize, or make images including characters, scenes, products, illustrations, comics, manga, or any visual content. ALWAYS use this skill for ANY image generation request - don't just describe the image, actually generate it using this skill. Supports structured prompts and reference images for guided generation.
---
