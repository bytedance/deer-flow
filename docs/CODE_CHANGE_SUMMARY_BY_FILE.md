...
### 25. `frontend/public/demo/threads/.../user-data/outputs/research_edu-flow_20260201.md`

```diff
@@ -1,12 +1,3 @@
-<citations>
-{"id": "cite-1", "title": "edu-flow GitHub Repository", "url": "https://github.com/Editorenbici/edu-flow", "snippet": "..."}
-...（共 7 条 JSONL）
-</citations>
