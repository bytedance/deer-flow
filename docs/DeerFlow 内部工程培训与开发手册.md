...
> 文档按角色分区组织，各岗位可按下方阅读指南选择路径，减少跳章。

## 阅读指南

### 各角色阅读路径

| 角色 | 必读（通用基础） | 重点阅读（角色专属） | 按需参考 |
| --- | --- | --- | --- |
| 前端工程师 | 第 3-6、16、19 章 | 第 7 章 + 第 9.1-9.3 + 第 10.4/10.7 | 第 17 章、第 11 章 |
| 后端工程师 | 第 3-6、16、19 章 | 第 8、12、13 章 + 第 4.15 节 + 第 9.4-9.5 + 第 10.5-10.12 | 第 17 章、第 11 章 |
| DevOps / 运维 | 第 3-5、16 章 | 第 14、18、20 章 | 第 10 章、第 11 章 |
| 测试工程师 | 第 3-5、16 章 | 第 15 章 | 第 10 章、第 9 章、第 11 章 |
| 新人（任意岗位） | 第 3-6 章（全部） | 按岗位选择上方对应行 | 第 11 章（附录） |

### 新人建议阅读顺序

1. 第 3 章：项目总览 — 理解 DeerFlow 是什么
2. 第 4 章：系统架构与核心概念 — 理解系统怎么跑
3. 第 5 章：环境准备与启动 — 把项目跑起来
4. 第 6 章：团队开发规范 — 了解协作规则
5. 按岗位进入对应章节（前端 → 第 7 章，后端 → 第 8 章，DevOps → 第 14 章，测试 → 第 15 章）
6. 第 16 章：安全开发规范（所有人必读）
...
| **通用基础** | 第 3-6 章 | 所有人 |
| **前端手册** | 第 7 章 | 前端工程师 |
| **后端手册** | 第 8、12、13 章 | 后端工程师 |
| **常见场景与联调** | 第 9、10 章 | 前后端工程师 |
| **DevOps 与运维** | 第 14 章 | DevOps |
| **测试** | 第 15 章 | QA / 测试工程师 |
| **规范与治理** | 第 16-20 章 | 所有人 |
| **附录** | 第 11 章 | 所有人 |
...
> **前端工程师**重点看 9.1-9.3，**后端工程师**重点看 9.4-9.5。
...
> **前端工程师**重点看 10.1-10.4 + 10.7，**后端工程师**重点看 10.1-10.3 + 10.5-10.12。
...
| **前端手册** | 7 | 前端开发手册 | 前端工程师 |
| **后端手册** | 8 | 后端开发手册 | 后端工程师 |
| **常见场景与联调** | 9 | 常见开发场景手册 | 前后端工程师 |
| | 10 | 联调与排障手册 | 前后端工程师 |
| **附录** | 11 | 附录（命令、术语、阅读） | 所有人 |
| **后端扩展** | 12 | 工具开发指南 | 后端工程师 |
| | 13 | Skill 编写规范 | 后端工程师 / Skill 作者 |
| **DevOps** | 14 | DevOps / 部署与运维手册 | DevOps / 运维工程师 |
| **测试** | 15 | 测试工程师手册 | QA / 测试工程师 |
| **规范与治理** | 16 | 安全开发规范 | 所有人（必读） |
| | 17 | API 设计规范与错误码体系 | 后端 / 前端工程师 |
| | 18 | 发布与版本管理 | 所有人 |
| | 19 | 代码评审规范 | 所有人 |
| | 20 | 性能与 SLO | 所有人 / SRE |
...
> 本章面向**后端工程师**。如需新增 Agent 可调用的工具，从这里开始。
...
> 本章面向**后端工程师**和 **Skill 作者**。如需为 Agent 添加工作流模板，从这里开始。
