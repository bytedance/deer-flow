#!/usr/bin/env bash
#
# start_docker_offline.sh — Start DeerFlow Docker services from pre-built images
#
# 用法:
#   ./start_docker_offline.sh    # 启动（不重建）
#   ./start_docker_offline.sh down  # 停止并移除容器
#
# 前置条件:
...
echo ""
echo "  ./start_docker_offline.sh down  — stop containers"
echo ""