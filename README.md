...
Archive installs and agent-managed support-file writes apply the same executable policy to files under the top-level `scripts/` directory, known code suffixes anywhere in the skill tree, and extensionless files beginning with a shebang.
