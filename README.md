...
LocalSandbox translates host paths in agent-written files back to virtual mount paths on readback, including native and forward-slash Windows spellings.
