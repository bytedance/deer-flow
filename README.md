...
On Windows, run the local development flow from Git Bash or WSL. Native `cmd.exe` and PowerShell shells are not supported for the bash-based service scripts.
