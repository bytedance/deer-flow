...
Queue polling follows the configured request interval, including high-RPM
settings; local queue overflow and timeout errors are not retried as provider failures.
