...
---
Concise AGENTS.md generated for coding-agent onboarding. If you want, I can add quick reference snippets for common test commands per-target (channels, memory, sandbox, client) or expand the CI matrix details.
