...
name_zh: 前端设计
description_zh: 创建独特的、生产级的前端界面，具有高设计质量。当用户要求构建 Web 组件、页面、制品、海报或应用程序时使用此技能（示例包括网站、落地页、仪表板、React 组件、HTML/CSS 布局，或在美化任何 Web UI 时）。生成创意、精致的代码和 UI 设计，避免通用的 AI 美学。
---
