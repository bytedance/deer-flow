...
_MODULE = load_data_analyst_module("query_diagnosis.py", "_rotating_query_diagnosis")
build_result = getattr(_MODULE, "build_result", None)
write_payload = getattr(_MODULE, "write_payload", None)
