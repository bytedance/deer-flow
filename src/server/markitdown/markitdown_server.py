...
async def convert_to_markdown_with_image(uri: str) -> str:
    """Convert a resource described by an http:, https:, file: or data: URI to markdown
...
if __name__ == "__main__":
    ...
    mcp = FastMCP("markitdown", **settings)
    mcp.add_tool(convert_to_markdown)
    mcp.add_tool(convert_to_markdown_with_image)
