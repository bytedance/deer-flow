...
- **Scope-safe writes**: Middleware extraction stores only durable, descriptive user-level facts; global summaries, contradiction removals, and consolidated facts fail closed when scope metadata is missing or task/project-local
