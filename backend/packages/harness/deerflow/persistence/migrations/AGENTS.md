...
- `migrations/versions/0018_user_preferences.py` — extends `0017_personal_access_tokens` with nullable user-level preference JSON plus its optimistic concurrency revision; both columns use idempotent add/drop helpers
