...
class AioSandbox(Sandbox):
    """Sandbox implementation using the 代理-infra/sandbox Docker container.
    ...
    def __init__(self, id: str, base_url: str, home_dir: str | None = None):
        ...
        Args:
            标识符: Unique identifier for this sandbox instance.
            base_url: URL of the sandbox API (e.g., http://localhost:8080).
            home_dir: Home 目录 inside the sandbox. If None, will be fetched from the sandbox.
        """
        super().__init__(id)
    ...
    def home_dir(self) -> str:
        """Get the home 目录 inside the sandbox."""
    ...
    def read_file(self, path: str) -> str:
        """Read the content of a 文件 in the sandbox.
    ...
    def list_dir(self, path: str, max_depth: int = 2) -> list[str]:
        """List the contents of a 目录 in the sandbox.
        ...
        """
        try:
            #    Use shell command to 列表 目录 with depth limit


            #    The -L flag limits the depth 对于 the tree command
    ...
    def write_file(self, path: str, content: str, append: bool = False) -> None:
        """Write content to a 文件 in the sandbox.

        Args:
            路径: The absolute 路径 of the 文件 to write to.
            content: The text content to write to the 文件.
            append: Whether to append the content to the 文件.
        """
        try:
            if append:
                #    Read existing content 第一 and append
    ...
    def update_file(self, path: str, content: bytes) -> None:
        """Update a 文件 with binary content in the sandbox.
