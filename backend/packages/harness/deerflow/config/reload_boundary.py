...
STARTUP_ONLY_FIELDS: dict[str, str] = {
    ...
    # config.yaml edits.
    "channels": ("start_channel_service() is invoked once during startup; the live IM channel clients (Feishu, DingTalk, WeChat, WeCom) are not rebuilt when channels.* changes."),
    "channel_connections": (
