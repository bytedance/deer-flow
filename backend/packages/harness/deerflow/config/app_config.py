...
from deerflow.config.global_variables_config import GlobalVariablesConfig, load_global_variables_config_from_dict
...
class AppConfig(BaseModel):
    ...
    global_variables: GlobalVariablesConfig = Field(default_factory=GlobalVariablesConfig, description="Global variables subsystem configuration")
    ...
    def from_file(cls, config_path: str | None = None) -> Self:
        ...
        # Load global_variables config if present
        if "global_variables" in config_data:
            load_global_variables_config_from_dict(config_data["global_variables"])
