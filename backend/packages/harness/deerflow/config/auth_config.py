...
class OIDCProviderConfig(BaseModel):
    ...
    allow_email_linking: bool = Field(
        default=False,
        description="Link an existing local account to this OIDC identity when the email matches. Requires the provider to report a verified email. Disabled by default for security.",
    )
