...
This 模块 provides a patched version of ChatDeepSeek that properly handles
...
on all assistant messages when thinking mode is 已启用.
"""
...
class PatchedChatDeepSeek(ChatDeepSeek):
    ...
    When using thinking/reasoning 已启用 models, the API expects reasoning_content
    ...
    def _get_request_payload(
        ...
        **kwargs: Any,
        ...
        """Get 请求 payload with reasoning_content preserved.

        Overrides the parent 方法 to inject reasoning_content from
