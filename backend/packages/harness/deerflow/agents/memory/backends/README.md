...
- `openviking/` - optional remote OpenViking backend over HTTP. It appends
  completed turns, recalls thread-aware context, and archives at configured
  token, idle, and pre-compaction boundaries (middleware mode).
