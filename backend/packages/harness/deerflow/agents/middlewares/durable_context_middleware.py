...
def _render_durable_context_data(summary_text: str | None, ledger: list, skills: list, task_notes: dict | None = None, task_history: dict | None = None, truncated_count: int = 0) -> str:
    data_parts: list[str] = []
    if summary_text:
