...
uploading their prepared projection is one per-user/thread critical section,
shared with acquire and release. A second policy sync cannot reset the remote
