...
from deerflow.integrations.tools.workbench_tools import WorkbenchTools
...
class ToolRegistry:
    ...
    async def initialize(self) -> None:
        ...
        workbench_service = WorkbenchService(self._router)
        ...
        self._tools["workbench"] = WorkbenchTools(workbench_service)
