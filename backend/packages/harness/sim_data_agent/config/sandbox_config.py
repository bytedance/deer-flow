...
class SandboxConfig(BaseModel):
    ...
    AioSandboxProvider specific options:
        ...
        container_prefix: Prefix for container names (default: sim-data-agent-sandbox)
    ...
    use: str = Field(
        ...,
        description="Class path of the sandbox provider (e.g. sim_data_agent.sandbox.local:LocalSandboxProvider)",
    )
