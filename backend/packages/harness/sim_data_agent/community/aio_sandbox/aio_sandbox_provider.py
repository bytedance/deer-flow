...
from sim_data_agent.config.paths import VIRTUAL_PATH_PREFIX, Paths, get_paths
from sim_data_agent.sandbox.sandbox import Sandbox
from sim_data_agent.sandbox.sandbox_provider import SandboxProvider
...
DEFAULT_PORT = 8080
DEFAULT_CONTAINER_PREFIX = "sim-data-agent-sandbox"
...
class AioSandboxProvider(SandboxProvider):
    ...
    Configuration options in config.yaml under sandbox:
        use: sim_data_agent.community.aio_sandbox:AioSandboxProvider
        image: <container image>
        port: 8080                      # Base port for local containers
        container_prefix: sim-data-agent-sandbox
