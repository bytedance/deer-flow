...
from sim_data_agent.mcp.client import build_servers_config
from sim_data_agent.mcp.oauth import build_oauth_tool_interceptor, get_initial_oauth_headers
...
async def get_mcp_tools() -> list[BaseTool]:
    ...
    try:
        ...
        # Patch tools to support sync invocation, as sim_data_agent client streams synchronously
        for tool in tools:
