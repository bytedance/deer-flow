...
Usage::
    ...
    from sim_data_agent.agents.checkpointer.provider import get_checkpointer, checkpointer_context
...
from sim_data_agent.config.checkpointer_config import CheckpointerConfig
from sim_data_agent.config.paths import resolve_path
...
def get_checkpointer() -> Checkpointer:
    ...
    from sim_data_agent.config.app_config import _app_config
    from sim_data_agent.config.checkpointer_config import get_checkpointer_config
