"""SIM-DATA-AGENTClient — Embedded Python client for SIM-DATA-AGENT agent system.

Provides direct programmatic access to SIM-DATA-AGENT's agent capabilities
without requiring LangGraph Server or Gateway API processes.

Usage:
    from sim_data_agent.client import SIM-DATA-AGENTClient

    client = SIM-DATA-AGENTClient()
...
from sim_data_agent.agents.lead_agent.agent import _build_middlewares
from sim_data_agent.agents.lead_agent.prompt import apply_prompt_template
from sim_data_agent.agents.thread_state import ThreadState
from sim_data_agent.config.agents_config import AGENT_NAME_PATTERN
from sim_data_agent.config.app_config import get_app_config, reload_app_config
...
from sim_data_agent.models import create_chat_model
from sim_data_agent.skills.installer import install_skill_from_archive
from sim_data_agent.uploads.manager import (
...
class SIM-DATA-AGENTClient:
    """Embedded Python client for SIM-DATA-AGENT agent system.
    ...
    def _ensure_agent(self, config: RunnableConfig):
        ...
        if checkpointer is None:
            from sim_data_agent.agents.checkpointer import get_checkpointer
    ...
    def _get_tools(*, model_name: str | None, subagent_enabled: bool):
        ...
        from sim_data_agent.tools import get_available_tools
    ...
    def _serialize_message(msg) -> dict:
        ...
        if isinstance(msg, ToolMessage):
            return {
                "type": "tool",
                "content": SIM-DATA-AGENTClient._extract_text(msg.content),
    ...
    def list_skills(self, enabled_only: bool = False) -> dict:
        ...
        """
        from sim_data_agent.skills.loader import load_skills
    ...
    def get_memory(self) -> dict:
        ...
        """
        from sim_data_agent.agents.memory.updater import get_memory_data
    ...
    def reload_memory(self) -> dict:
        ...
        """
        from sim_data_agent.agents.memory.updater import reload_memory_data
    ...
    def upload_files(self, thread_id: str, files: list[str | Path]) -> dict:
        ...
        """
        from sim_data_agent.utils.file_conversion import CONVERTIBLE_EXTENSIONS, convert_file_to_markdown
    ...
    def delete_upload(self, thread_id: str, filename: str) -> dict:
        ...
        """
        from sim_data_agent.utils.file_conversion import CONVERTIBLE_EXTENSIONS
    ...
    def get_artifact(self, thread_id: str, path: str) -> tuple[bytes, str]:
        ...
        try:
            ...
            if "traversal" in str(exc):
                from sim_data_agent.uploads.manager import PathTraversalError
