...
_STATUS_BY_ERROR: dict[type[ScheduleError], int] = {
    ...
    # The service already retried a bounded number of rounds; reaching here
    # means the row kept moving under it. 409 says "retry", which is exactly
    # what a client can usefully do.
