...
It is the canonical operator-facing configuration reference. For loader architecture,
precedence, caching, and invalidation, see [Configuration System](CONFIGURATION_SYSTEM.md).
