...
- Cancel-stuck and multi-instance reconciliation now read the latest run row and finalise the parent task to match (success→completed, failed→failed, interrupted→cancelled, skipped→cancelled) instead of blindly cancelling.
