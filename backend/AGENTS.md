...
**Virtual Path System**:
- Agent sees: `/mnt/user-data/{workspace,uploads,outputs}`, read-only `/mnt/user-data/.upload-conversions`, and `/mnt/skills`
