"""Live integration tests for EduFlowClient with real API.
...
from src.client import EduFlowClient, StreamEvent
...
def client():
    """Create a real EduFlowClient (no mocks)."""
    return EduFlowClient(thinking_enabled=False)
