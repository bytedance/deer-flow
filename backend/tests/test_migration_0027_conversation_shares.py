"""Migration tests for 0027_conversation_shares (#4548).
...
_REVISION = "0027_conversation_shares"
_PREVIOUS = "0026_mcp_task_lease_tokens"


def test_pins_immediate_parent_revision() -> None:
    """The renumbers after main's MCP lease-token revision must not drift again."""
    import importlib.util
    from pathlib import Path

    module_path = Path(_MIGRATIONS_DIR) / "versions" / "0027_conversation_shares.py"
