        ...
        if race:
            ...
            monkeypatch.setattr(
                ...
                lambda: (
                    ...
                    # The rolled-back binary predates 0021 and the incarnations
                    # revision alike; with the shares merge the tree head is a
                    # third revision it must also not know.
                    current_revisions - {"0021_batch_acceptance", "0019_thread_incarnations", current_head},
                ),
            )
