...
class TestEnsureAgent:
    def test_uses_custom_agent_subagent_defaults_when_request_omits_them(self, client):
        ...
        mock_get_tools.assert_called_once_with(model_name="test-model", subagent_enabled=True, mcp_plugins=None)
    ...
    def test_explicit_subagent_disable_overrides_custom_agent_default(self, client):
        ...
        mock_get_tools.assert_called_once_with(model_name="test-model", subagent_enabled=False, mcp_plugins=None)
