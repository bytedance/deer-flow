...
class TestInstallSkillFromArchive:
    ...
    def test_success(self, tmp_path):
        ...
        skills_root.mkdir()
        result = get_or_new_skill_storage(skills_path=skills_root).get_or_new_skill_storage().install_skill_from_archive(zip_path)
    ...
    def test_scans_skill_markdown_before_install(self, tmp_path, monkeypatch):
        ...
        get_or_new_skill_storage(skills_path=skills_root).get_or_new_skill_storage().install_skill_from_archive(zip_path)
