"""Migration tests for 0026_conversation_share_quotas (#4548).
...
_REVISION = "0026_conversation_share_quotas"
_PREVIOUS = "0025_conversation_shares"
...
def test_pins_immediate_parent_revision() -> None:
    ...
    module_path = Path(_MIGRATIONS_DIR) / "versions" / "0026_conversation_share_quotas.py"
