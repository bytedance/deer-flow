...
# Merge resolution: this branch carries 0019_conversation_shares as the
# local head; the forward-compat window below keys on the distinct
# 0019_thread_incarnations revision id and is unaffected by the number.
HEAD = "0019_conversation_shares"
