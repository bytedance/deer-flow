...
class TestAsyncCheckpointer:
    ...
    async def test_sqlite_creates_parent_dir_via_to_thread(self):
        ...
        with (
            ...
            patch("deerflow.runtime.checkpointer.async_provider.asyncio.to_thread", new_callable=AsyncMock, return_value="/tmp/resolved/test.db") as mock_to_thread,
        ):
    ...
    async def test_database_sqlite_creates_parent_dir_via_to_thread(self):
        ...
        assert called_fn.__name__ == "_prepare_database_sqlite_checkpointer_path"
