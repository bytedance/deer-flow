...
Defines the `weekly-report` skill as a fully self-contained unit that includes all scripts and internal modules needed to generate equipment weekly reports, independent of the `data-analyst`, `daily-report`, and `monthly-report` skills.
