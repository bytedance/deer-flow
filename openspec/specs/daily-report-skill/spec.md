...
Defines the `daily-report` skill as a fully self-contained unit that includes all scripts and internal modules needed to generate equipment daily reports, independent of the `data-analyst`, `weekly-report`, and `monthly-report` skills.
